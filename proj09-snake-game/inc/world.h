...
struct world
{
  unsigned int rows;         // Rows in world matrix
  unsigned int cols;         // Cols in world matrix
  unsigned int snake_length; // Current snake length
  struct snake *snake;
  enum cell **board; // World matrix
};
